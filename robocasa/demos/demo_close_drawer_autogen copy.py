...
def _parse_close_autogen_args(original_parse_args):
    ...
    # Always pop the skeleton + panda_hand-rectangle visualizations in autogen
    # mode (matches demo_open_drawer_autogen.py), and force the QP path with
    # multi-theta sampling so contact rotations are not collapsed to the demo
    # EE orientation via the R0_override bypass in ee_skelton.solve_skeleton_pose.
    ...
    args.autogen_visualize_skeleton = True
